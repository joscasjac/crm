...
// CONTEXT_DEV_API_KEY stays "unset" here on purpose: the sentinel keeps the
// deploy working with no key, and the app degrades honestly without it.
const SETUP_PROMPT =
  "Set up waynesutton/trycrm-convex. Install the dependencies with npm, run npx convex dev to create my deployment, set CONTEXT_DEV_API_KEY to unset, and tell me which optional keys I still need.";
...
function Hero() {
  return (
    <section className="relative overflow-hidden">
      ...
      />
      <div className="relative mx-auto max-w-3xl px-4 pb-20 pt-24 text-center">
        ...
        <div className="mt-8 flex items-center justify-center gap-3">
          <Link
            to="/app"
            className="rounded-md bg-primary px-5 py-2.5 text-sm text-white transition-colors hover:bg-primary-hover"
          >
            Try the demo
          </Link>
          <CopyPromptButton />
...
function BuiltWith() {
  return (
    <section className="border-y border-edge py-8">
      <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-center gap-x-10 gap-y-4 px-4">
        ...
        <a
          ...
          aria-label="React"
        >
          <img src="/logos/react-white.svg" alt="" className="h-5 w-5" />
        ...
        <a
          ...
          aria-label="Vite"
        >
          <img src="/logos/vite-white.svg" alt="" className="h-5 w-5" />
...
function AgentsSection() {
  return (
    <section className="mx-auto max-w-3xl px-4 py-20">
      ...
      <div className="mt-8 rounded-lg border border-edge bg-panel p-6">
    ...
    <section className="mx-auto max-w-3xl px-4 pb-20">
      <div className="rounded-lg border border-edge bg-panel p-6">
        ...
        <ul className="mt-3 flex flex-col gap-2 text-sm leading-relaxed text-neutral-400">
          ...
          <li>
            Email is wired through the Resend component but not configured on
            the demo. Set RESEND_API_KEY on your own deployment to turn it on.
          </li>
          <li>
            Enrichment and record chat degrade honestly: without
            CONTEXT_DEV_API_KEY or OPENAI_API_KEY they say so instead of
            faking results.
          </li>
        </ul>
      </div>
...
function ForkIt() {
  return (
    <section className="border-t border-edge py-20 text-center">
    ...
    <footer className="border-t border-edge py-10">
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-4 px-4 text-center">
        <div className="flex items-center gap-2.5">
          <img src="/convex-logo-white.png" alt="Convex" className="h-4" />
